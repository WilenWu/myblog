...
$$
![](https://img-blog.csdnimg.cn/20200526160318156.PNG)
...
![](https://img-blog.csdnimg.cn/20200526160401609.PNG) 
- **向量的线性运算**
加法：$\mathbf{c=a+b}$ 遵循平行四边形法则（或三角形法则）
数乘：$λ\mathbf a$ 方向与 $\mathbf a$ 相同，模 $|λ\mathbf a|=|λ||\mathbf a|$
![](https://img-blog.csdnimg.cn/20200526160401613.PNG) ![](https://img-blog.csdnimg.cn/20200526160401648.PNG)  
...
![](https://img-blog.csdnimg.cn/20200526160401690.PNG)
- **方向角和方向余弦**：向量 $\mathbf r$ 与三个坐标轴的夹角 $\alpha,\beta,\gamma$ 称为==方向角==，$\cosα,\cosβ,\cosγ$ 称为 $\mathbf r$ 的==方向余弦==。
![](https://img-blog.csdnimg.cn/202005261621247.PNG)
...
![](https://img-blog.csdnimg.cn/20200526162816875.PNG)
...
$$
![](https://img-blog.csdnimg.cn/2020052616353884.PNG)
- **平面一般方程** 
$$
Ax+By+Cz+D=0
$$
...
$$
![](https://img-blog.csdnimg.cn/20200526164305512.PNG)

- **两平面的夹角**(included angle)：两平面法线的夹角。
$$
\cos\theta=|\cos(\widehat{\mathbf n_1,\mathbf n_2})|
$$
![](https://img-blog.csdnimg.cn/20200526164320413.PNG)
...
![](https://img-blog.csdnimg.cn/20200526171558543.PNG)
(6) 双曲抛物面(hyperbolic paraboloid)（马鞍面） $\dfrac{x^2}{a^2}-\dfrac{y^2}{b^2}=z$
![](https://img-blog.csdnimg.cn/20200526171621498.PNG)
...
![](https://img-blog.csdnimg.cn/20200526171815985.PNG)
(3) 空间曲线在坐标面上的投影
