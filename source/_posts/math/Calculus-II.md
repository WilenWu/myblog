...
$$
![](img/vector-objective-function.png) ![](img/vector-objective-function-limit.png)
...
![](img/double-integral-demo1.png) ![](img/double-integral-demo2.png)
...
$$
![](img/quadratic-integral-X.png) ![](img/quadratic-integral-II.png)
...
$$
![](img/quadratic-integral-Y.png)
   (3) 如果积分区域既不是 $X$ 型区域，也不是 $Y$ 型区域，这时可以把 $D$ 分成几部分求和。
![](img/quadratic-integral-XY.png)
**示例**：求两个底圆半径都是 $R$ 的直交圆柱面围成的立体的体积。
![](img/double-integral-demo3.png)
解：设这两个圆柱面的方程为 
...
$$
   ρ_1(θ)⩽ ρ ⩽ ρ_2(θ),α⩽θ⩽ β
$$
![](img/double-integral-polar.png) ![](img/quadratic-integral-polar.png)
   二次积分的值为
$$
...
$$
![](img/double-integral-substitution.png)
...
$$
![](img/triple-integral-cylindrical-I.png)  ![](img/triple-integral-cylindrical-II.png)
...
$$
![](img/triple-integral-spherical-I.png)  ![](img/triple-integral-spherical-II.png)
...
$$
![](img/area-of-surface-I.png)![](img/area-of-surface-II.png)
...
![](img/curvilinear-integral-typeII.png)
...
![](img/oriented-surface1.png) ![](img/oriented-surface2.png)
...
$$
![](img/surface-integral-typeII.png)
...
![](img/2ds-simplyconnected-domain.png)
...
\end{aligned}
$$
![](img/right-hand-rule.png) ![](img/Stokes-formula.png)
...
![](img/space-path-independence.png)
