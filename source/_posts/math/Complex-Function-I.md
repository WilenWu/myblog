...
![复球面](https://img-blog.csdnimg.cn/20190705145704554.png =250x)
...
![等值线](https://img-blog.csdnimg.cn/20190802143729298.png)
...
如果函数$f(z)$在单连通区域D内解析，则$f(z)$在D内沿任一简单闭曲线$Γ$积分 $$\displaystyle\oint_{Γ}f(z)dz=0$$ ![](https://img-blog.csdnimg.cn/20200523180327885.PNG =250x)
证：$\begin{aligned}
