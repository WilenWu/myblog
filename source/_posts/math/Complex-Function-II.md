...
<kbd>定理 1</kbd>：设闭曲线C是区域D的边界线，函数$f(z)$在D内除极点外每一点都解析，并且在C上解析，则$$\displaystyle\dfrac{1}{2π i }\oint_{C}\dfrac{f'(z)}{f(z)}dz=P-N$$这里P和N分别表示在D内零点[^1]及极点的总数， 而且每个k阶零点或极点分别算作k个零点或极点。
...
![线性映射1](https://img-blog.csdnimg.cn/20190805122657775.png)
...
![线性映射2](https://img-blog.csdnimg.cn/20190805122730470.png)
...
![茹科夫斯基变换](https://img-blog.csdnimg.cn/20190805143823190.png)